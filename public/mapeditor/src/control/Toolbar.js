...
ME.Control.Button.delete = new ME.Control.Button({
		...
		handler: function(){
            ...
            // var hollowpolygon = new ME.DonutPolygon([[[31.208727306088207,121.4232587814331],[31.210122080671784,121.44338607788085],[31.19767849645092,121.44514560699463],[31.197751914727228,121.42261505126953]],
            ...
            // var hollow = new ME.Donut(hollowpolygon, {editable:true});
            // map.addLayer(hollow);
