;(function(ME){
    ME.Config = {
        ...
        data :  {
            ...
            areaSelectRoadNameUrl:"http://api.bmap.amap.com/sorting_web/gate?sid=3001&encode=utf-8",
            getDistrictBoundsUrl: "http://api.bmap.amap.com/sorting_web/gate?sid=2012",
            getCityRingUrl:"http://api.bmap.amap.com/sorting_web/gate?sid=2010",
            loadParas : {
                sid : '2006',
                encode : 'utf-8',
